...
int main(int argc, char **argv)
{
    ...
    switch(V) {
        ...
        case 2: {
            ...
            for (j = 1; j <= I; j++)
                StencilOPT((j % 2) == 1 ? A : B, (j % 2) == 1 ? B : A, N);
        ...
        case 3: {
            ...
            for (j = 1; j <= I; j+=2)
                if (j % 4 <= 1)
                    StencilBlock(A, C, B, D, N);
                else
                    StencilBlock(D, B, C, A, N);
        ...
        case 5: {
            ...
            #pragma acc data copyin(A[0:N+1], B[0:N+1]) present(B[0:N+1])
            {
                        for (j = 1; j <= I; j++)
                            #pragma acc kernels
                            {
    ...
    //                        StencilACC((j % 2) == 1 ? A : B, (j % 2) == 1 ? B : A, N);
            ...
            printf ("Execution on GPU took %f sec\n", (t_final - t_start));
        ...
        case 7: {
            ...
            for (j = 1; j <= I; j+=2)
                if (j % 4 <= 1)
                    StencilBlkNT(A, C, B, D, N);
                else
                    StencilBlkNT(D, B, C, A, N);
        ...
        case 9: {
            ...
            for (j = 1; j <= I; j += 3)
                if (j % 6 <= 2)
                    StencilTriBlk(A, C, B, D, N);
                else
                    StencilTriBlk(D, B, C, A, N);
        ...
        case 10: {
            ...
            for (j = 1; j <= I; j += 3)
                if (j % 6 <= 2)
                    StencilTriBlkNT(A, C, B, D, N);
                else
                    StencilTriBlkNT(D, B, C, A, N);
